...
define('ga-wdi-boston.list-it/adapters/application', ['exports', '<project-4-listit-client/config/environment', 'active-model-adapter', 'ember'], function (exports, _project4ListitClientConfigEnvironment, _activeModelAdapter, _ember) {
  exports['default'] = _activeModelAdapter['default'].extend({
    host: _project4ListitClientConfigEnvironment['default'].apiHost,
...
if (!runningTests) {
  require("ga-wdi-boston.list-it/app")["default"].create({"name":"ga-wdi-boston.list-it","version":"0.0.0+966f43d3"});
}
